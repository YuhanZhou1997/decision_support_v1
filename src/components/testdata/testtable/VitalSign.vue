...
name: "VitalSign",
  ...
  computed: {
    ...
    selectData(){
      return {'date':this.$store.state.selectData.date,
        data:this.$store.state.selectData.data.Vital,}
  ...
  methods: {
    ...
    updateChart() {
      // 半透明的颜色值
      const colorArr1 = ['rgba(253,53,3,0.2)', 'rgb(199,27,151,0.2)','rgb(22,184,184,0.2)',  'rgb(224,116,129,0.2)', 'rgb(80,186,41,0.2)','rgb(243,183,27,0.2)']
      // 全透明的颜色值
      const colorArr2 = ['rgba(253,53,3,0)', 'rgb(199,27,151,0)','rgb(22,184,184,0)',  'rgb(224,116,129,0)', 'rgb(80,186,41,0)','rgb(243,183,27,0)']
      // 线条颜色
      const colorArr = ['rgb(253,53,3)', 'rgb(199,27,151)','rgb(22,184,184)',  'rgb(224,116,129)', 'rgb(80,186,41)','rgb(243,183,27)']
