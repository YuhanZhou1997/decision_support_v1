...
name: "PvaRate",
  ...
  computed: {
    ...
    selectData(){
      return {'date':this.$store.state.selectData.date,
        data:this.$store.state.selectData.data.PvaRate,}
  ...
  methods: {
    ...
    updateChart() {
      // 半透明的颜色值
      const colorArr1 = ['rgba(1,252,6,0.5)','rgba(0,115,250,0.5)', 'rgba(199,3,253,0.5)',  'rgba(94,15,222,0.5)', 'rgba(250, 105, 0, 0.5)']
      // 全透明的颜色值
      const colorArr2 = ['rgba(1,252,6, 0)','rgba(0,115,250,0)', 'rgba(199,3,253, 0)',  'rgba(94,15,222, 0)', 'rgba(250, 105, 0, 0)']
      // 线条颜色
      const colorArr = ['rgb(1,252,6)','rgb(0,115,250)', 'rgb(199,3,253)',  'rgb(94,15,222)', 'rgb(250, 105, 0)']
      // x轴数据
